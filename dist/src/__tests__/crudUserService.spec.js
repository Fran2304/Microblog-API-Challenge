...
describe('create a new user', function () {
    it('should return a lowercase string  if we pass capital letters', function () { return __awaiter(void 0, void 0, void 0, function () {
        var comment, expected;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.comment.findFirst({
                        where: {
                            id: 2,
                        },
                    })];
...
//     })
// })
//# sourceMappingURL=crudUserService.spec.js.map