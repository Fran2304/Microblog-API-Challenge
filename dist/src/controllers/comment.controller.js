...
var commentService = __importStar(
    require('../services/comment/crudCommentService')
)
...
var readComment = function (req, res) {
    return __awaiter(void 0, void 0, void 0, function () {
        var e_5
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [
                        4 /*yield*/,
                        commentService.readComment(req.params.id),
                    ]
                case 1:
                    _a.sent()
                    res.status(204).end()
